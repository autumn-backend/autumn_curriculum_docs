...
#### 【PHP_5-1】 クラスの中に、価格を渡したら税込価格を返す関数を作成し、実行してください。(税 10%)
...
#### 【PHP_5-4】 クラスの外から税込価格を呼ぶ関数を呼び出し、呼び出せた場合は税込価格、 呼び出せなかった場合はエラーの文字列を表示するという例外処理を作成してください。
...
#### 【PHP_8-1】 クラスの中にある func()を呼んでみましょう。

<!-- #### 【PHP_8−2】 クラスの外から func()を呼び出力してみましょう。(1 の形式と同じように出力してください) -->

#### 【PHP_8-2】 クラスの外から呼べるクラス内の配列リストの中で、20 歳以上のメンバーの名前を$ans 配列に格納し、「〜・〜さんは 20 歳以上です。」と 1 行で出力しましょう。
